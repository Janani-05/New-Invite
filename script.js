document.addEventListener('DOMContentLoaded', () => {
    ...
    // Auto-start music on first user click anywhere on screen (bypasses browser autoplay restrictions)
    ...
    if (scratchCanvas) {
        ...
        function initScratchCard() {
            ...
            // Add instruction on scratch surface
    ...
    /* ==========================================
       5. COUNTDOWN TIMER
       ========================================== */
    // Target date: September 12, 2026, 19:00:00 IST
    ...
    function updateTimer() {
        ...
        if (diff <= 0 && timerElem) {
            timerElem.innerHTML = '<h3 style="color:var(--gold-light);">The Reception Has Begun!</h3>';
            return;
        }
